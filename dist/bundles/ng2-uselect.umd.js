(function (global, factory) {
	...
	(factory((global['ng2-uselect'] = {}),global.ng.core,global.ng.common,global.ng.forms));
 ...
 * @nocollapse
 */
UselectDefaultConfig.ctorParameters = function () { return []; };
var UselectComponent = /** @class */ (function () {
    ...
    UselectComponent.prototype.sortValue = function () {
        ...
        if (!this.sortKey)
            return /** @type {?} */ (this.value);
        return lodash.sortBy(this.value, function (val) {
     ...
     * @return {?}
     */
    UselectComponent.prototype.allCheck = function () {
        return !!this.service;
    };
    /**
     * @param {?} index
...
AbstractComponent = __decorate$3([
    core.Injectable(),
    __metadata$2("design:paramtypes", [core.ElementRef, DragDropService, DragDropConfig,
...
DraggableComponent = __decorate$2([
    ...
    __metadata$1("design:paramtypes", [core.ElementRef, DragDropService, DragDropConfig,
        core.ChangeDetectorRef])
], DraggableComponent);
...
DraggableHandleComponent = __decorate$2([
    ...
    __metadata$1("design:paramtypes", [core.ElementRef, DragDropService, DragDropConfig, DraggableComponent,
        core.ChangeDetectorRef])
...
DroppableComponent = __decorate$4([
    ...
    __metadata$3("design:paramtypes", [core.ElementRef, DragDropService, DragDropConfig,
        core.ChangeDetectorRef])
], DroppableComponent);
// Copyright (C) 2016-2018 Sergey Akopkokhyants
// This project is licensed under the terms of the MIT license.
...
SortableContainer = __decorate$5([
    ...
    __metadata$4("design:paramtypes", [core.ElementRef, DragDropService, DragDropConfig, core.ChangeDetectorRef,
        DragDropSortableService])
], SortableContainer);
...
SortableComponent = __decorate$5([
    ...
    __metadata$4("design:paramtypes", [core.ElementRef, DragDropService, DragDropConfig,
        SortableContainer,
        DragDropSortableService,
        core.ChangeDetectorRef])
], SortableComponent);
...
SortableHandleComponent = __decorate$5([
    ...
    __metadata$4("design:paramtypes", [core.ElementRef, DragDropService, DragDropConfig, SortableComponent,
        core.ChangeDetectorRef])
...
UselectModule.decorators = [
    { type: core.NgModule, args: [{
                imports: [common.CommonModule, forms.FormsModule, DndModule.forRoot()],
