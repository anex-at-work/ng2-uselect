import { Component, ContentChild, Directive, ElementRef, EventEmitter, HostListener, Injectable, Input, NgModule, Output, ViewChild, forwardRef } from '@angular/core';
...
var UselectComponent = /** @class */ (function () {
    ...
    UselectComponent.prototype.onUselectIndexChange = function ($event) {
        ...
        if (this._draggableIndexes.over != this._draggableIndexes.start) {
            var /** @type {?} */ overEl = this.value[this._draggableIndexes.over];
 ...
 * @nocollapse
 */
UselectSortableHandle.ctorParameters = function () { return []; };
...
var UselectSortableIndexDirective = /** @class */ (function () {
    ...
    UselectSortableIndexDirective.prototype.onDrag = function (event) {
        ...
        var /** @type {?} */ parent = event.target['closest']('.uselect__selected-items'), /** @type {?} */ percent = 0.2;
